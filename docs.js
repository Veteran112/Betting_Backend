	...
	paths: {
		...
		"/api/users/create": {
			post: {
				...
				description: "Method for creating user (info)<br><br>`All fields is not required!`",
				consumes: [ "multipart/form-data" ],
				security: [{Bearer: []}],
				parameters: [{
					in: "formData",
		...
		"/api/providers/{id}": {
			...
			put: {
				...
				description: "Method for updating current provider (info)<br><br>`All fields is not required!`",
				consumes: [ "multipart/form-data" ],
				security: [{Bearer: []}],
				parameters: [
				{
		...
		"/api/providers/create": {
			post: {
				...
				description: "Method for creating provider (info)<br><br>`All fields is not required!`",
				consumes: [ "multipart/form-data" ],
				security: [{Bearer: []}],
				parameters: [{
					in: "formData",
		...
		"/api/commands/{id}": {
			...
			put: {
				...
				description: "Method for updating current Command (info)<br><br>`All fields is not required!`",
				consumes: [ "multipart/form-data" ],
				security: [{Bearer: []}],
				parameters: [
				{
		...
		"/api/providers/create": {
			post: {
				...
				description: "Method for creating command (info)<br><br>`All fields is not required!`",
				consumes: [ "multipart/form-data" ],
				security: [{Bearer: []}],
				parameters: [{
					in: "formData",
